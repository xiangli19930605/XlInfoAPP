package com.xgli.module_news.mvp.contract;
...
public interface SpecialNewsContract {
    ...
    interface View extends IView {
        void updateData(List<SpecialNewsBean> list );
        void updateBanner(String url);

    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model extends IModel {
        Observable<Map<String, RawSpecialNewsBean>> getSpecialNewsData(String specialIde);
        Observable<PhotoSetBean> getPhotoSetData(String photoId);
    }
}
